...
- Current Sprint: Sprint 26 — Advanced Hybrid Ranking — Complete
- Last Completed Task: Sprint 26 / Task 1 — Advanced Hybrid Ranking Framework
- Last Commit: (recorded after commit; Sprint 26 / Task 1)
- Validation: Established — `ruff check`, `mypy` (strict), `pytest` all passing (258 tests, up from 239, ~57s including PostgreSQL/testcontainers suites); `scripts/run_demo.py` re-run directly and inspected by hand (ALS is now part of the demo)
