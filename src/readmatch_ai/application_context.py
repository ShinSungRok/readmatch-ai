...
class ApplicationContext:
    ...
    def create(
        ...
        """Wire the Book use cases to a BookRepository and BookPopularityRepository.

        Each defaults independently via BookRepositoryConfig.from_env(): the
        InMemory adapters, or the PostgreSQL adapters when
